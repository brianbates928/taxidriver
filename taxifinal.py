...
aisles[0] = [i for i in range(0, 11)]
...
aisles[10] = [i for i in range(0, 10)]
...
rewards[0][5]=-1.
rewards[9][5]=100.
print("Path starting at [9,6]")
print(get_shortest_path(9, 6)) #starting at row 3, column 9
print("\n")
print("Path starting at [3,9]")
print(get_shortest_path(3, 9)) #starting at row 3, column 9
print("\n")
print("Path starting at [5,1]")
